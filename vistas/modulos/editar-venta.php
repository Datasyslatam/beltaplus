              ...
              <div class="box">
                ...
                <div class="form-group row nuevoProducto">
                  ...
                  foreach ($listaProducto as $key => $value) {
                    ...
                    $respuestaTalla = ControladorTallas::ctrMostrarTallas($item, $respuesta["id_talla"]);
                    $respuestaColor = ControladorColores::ctrMostrarColores($item, $respuesta["id_color"]);
                    ...
                    echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-6" style="padding-right:0px">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control nuevaDescripcionProducto" idProducto="' . $value["id"] . '" name="agregarProducto" value="' . $value["descripcion"] . ' ' . $respuestaColor . ' ' . $respuestaTalla . '" readonly required>
                          </div>
                        </div>
                        <div class="col-xs-3">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control input-lg" name="nuevaFechaNacimiento"
                  placeholder="Ingresar fecha nacimiento" required>
              </div>
            </div>
