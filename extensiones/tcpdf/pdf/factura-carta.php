...
$bloque2 = <<<EOF
	...
	<table style="border: white 0px;  background-color:white">
	...
	<table style="border: white 1px; font-size:10px; padding:5px 10px;">
		...
		<td style="border-bottom: 0px; background-color:white; width:540px"></td>
