...
class ModeloClientes{
	...
	public static function mdlIngresarCliente($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, documento, email, telefono, direccion, ciudad, fecha_nacimiento) VALUES (:nombre, :documento, :email, :telefono, :direccion, :ciudad, :fecha_nacimiento)");
	...
	public static function mdlEditarCliente($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, documento = :documento, email = :email, telefono = :telefono, direccion = :direccion,  ciudad = :ciudad, fecha_nacimiento = :fecha_nacimiento WHERE id = :id");
